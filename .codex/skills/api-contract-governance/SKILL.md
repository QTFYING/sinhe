...
2. 涉及阶段边界、改动范围和旧模块处置时，先看 `design/api-implementation-plan.md`；若涉及遗留问题或验证范围，再看 `design/api-technical-debt.md` 与 `design/api-regression-checklist.md`。
3. 本技能只负责契约治理，不替代仓库级总规则。
